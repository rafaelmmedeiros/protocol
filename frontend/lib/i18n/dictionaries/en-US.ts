...
export const enUS = {
  ...
  equipment: {
    ...
    items: {
      ...
      StandingLegCurlMachine: "Standing leg curl",
      HipAbductionMachine: "Hip abduction",
      SeatedCalfRaiseMachine: "Seated calf raise",
      StandingCalfRaiseMachine: "Standing calf raise",
      ChestPressMachine: "Chest press",
      PecDeckMachine: "Pec deck / rear delt fly",
      SeatedRowMachine: "Seated row",
      HighRowMachine: "High row",
      ShoulderPressMachine: "Shoulder press",
      PreacherCurlMachine: "Preacher curl",
    ...
    groups: {
      ...
      benchesAndRacks: "Benches and racks",
      cables: "Cables",
      machines: "Machines",
      other: "Other",
    },
