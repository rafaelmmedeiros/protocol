...
export const ptBR: Dictionary = {
  ...
  week: {
    ...
    markDone: "Marcar como treinada",
    skipSession: "Pular esta",
    nextUp: "próxima",
    outcomes: {
      Pending: "ainda não treinada",
      Bound: "treinada, casada com seu registro",
      Marked: "treinada",
      Skipped: "pulada",
    },
    swapTo: "Trocar por",
    ...
    directShort: "direto",
    indirectShort: "indireto",
    ofTarget: "de",
    shortOfFloor: "abaixo",
    uncoveredTitle: "Sem treino direto",
    uncoveredLead:
      "Nenhum exercício do catálogo treina estes como músculo principal, então eles só somam pelas séries contadas pela metade acima. Treinar mais não muda isso.",
    muscles: {
      Chest: "Peito",
      FrontDelts: "Deltoide anterior",
      SideDelts: "Deltoide lateral",
      RearDelts: "Deltoide posterior",
      Lats: "Dorsais",
      ...
      Calves: "Panturrilhas",
      Abs: "Abdômen",
      SpinalErectors: "Eretores da espinha",
      Adductors: "Adutores",
    },
    classes: {
      CompoundPrimary: "Composto pesado",
      CompoundSecondary: "Composto secundário",
      Isolation: "Isolado",
    },
    implements: {
      Barbell: "Barra",
      ...
      BodyweightLoadable: "Peso corporal, com carga",
      Band: "Elástico",
  ...
  equipment: {
    ...
    items: {
      ...
      HackSquatMachine: "Hack squat",
      LegExtensionMachine: "Cadeira extensora",
      SeatedLegCurlMachine: "Mesa flexora sentada",
      LyingLegCurlMachine: "Mesa flexora deitada",
      StandingLegCurlMachine: "Mesa flexora em pé",
      HipAbductionMachine: "Abdutora",
      SeatedCalfRaiseMachine: "Panturrilha sentado",
      StandingCalfRaiseMachine: "Panturrilha em pé",
      ChestPressMachine: "Supino máquina",
      PecDeckMachine: "Peck deck / voador invertido",
      SeatedRowMachine: "Remada sentada máquina",
      HighRowMachine: "Remada alta máquina",
      ShoulderPressMachine: "Desenvolvimento máquina",
      PreacherCurlMachine: "Rosca scott máquina",
      AbdominalMachine: "Abdominal máquina",
      BackExtensionBench: "Banco de hiperextensão",
      SmithMachine: "Smith",
    },
    groups: {
      freeWeights: "Peso livre",
      benchesAndRacks: "Bancos e suportes",
      cables: "Cabos",
      machines: "Máquinas",
      other: "Outros",
    },
